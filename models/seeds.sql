...
insert into skill_crap values (1, "LB skill 1", "LB must be proficient in skill 1",null,null);
insert into skill_crap values (2, "LB skill 2", "LBs must know a little about skill 2",null,null);
insert into skill_crap values (3, "BGs skill 1", "Pointy hair",null,null);
insert into skill_crap values (4, "BGs skill x", "Overly large bladder...for long meetings",null,null);
